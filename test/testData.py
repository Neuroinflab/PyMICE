...
class TestFileCollectionLoader_v_IntelliCage_Plus_3(BaseTest):
  ...
  INPUT_LOAD_MANY_VISITS_WITH_MISSING_VALUES = {
    ...
    'Start': ['1970-01-01 00:00:10.0',
              '1970-01-01 00:00:20.0',
              '1970-01-01 00:00:30.0',
              '1970-01-01 00:00:40.0',
              '1970-01-01 00:00:50.0',
              '1970-01-01 00:01:00.0',
              '1970-01-01 00:01:10.0',
              '1970-01-01 00:01:20.0',
              '1970-01-01 00:01:30.0',
              '1970-01-01 00:01:40.0'],
    'End': [None,
            '1970-01-01 00:00:35.00',
            '1970-01-01 00:00:45.00',
            '1970-01-01 00:00:55.00',
            '1970-01-01 00:01:05.00',
            '1970-01-01 00:01:15.00',
            '1970-01-01 00:01:25.00',
            '1970-01-01 00:01:35.00',
            '1970-01-01 00:01:45.00',
            '1970-01-01 00:01:55.00'],
  ...
  INPUT_LOAD_MANY_VISITS_MANY_NOSEPOKES = {
    ...
    'Nosepokes': {'VisitID': ['2', '3', '3', '4', '4', '4'],
                  'Start': ['1970-01-01 00:33:12.0',
                            '1970-01-01 00:33:02',
                            '1970-01-01 00:32:52',
                            '1970-01-01 00:32:42',
                            '1970-01-01 00:32:32',
                            '1970-01-01 00:32:22'],
                    'End': ['1970-01-01 00:33:17.0',
                            '1970-01-01 00:33:07',
                            '1970-01-01 00:32:57',
                            '1970-01-01 00:32:47',
                            '1970-01-01 00:32:37',
  ...
  INPUT_LOAD_LOG = {'DateTime': ['1970-01-01 00:00:00',
                                 '1970-01-01 01:00:00.',
                                 '1970-01-01 02:00:00.0',
                                 '1970-01-01 03:00:00.00',
                                 '1970-01-01 04:00:00.000'],
...
class TestFileCollectionLoader_v_Version2(TestFileCollectionLoader_v_IntelliCage_Plus_3):
  ...
  INPUT_LOAD_LOG = {'Time': ['1970-01-01 00:00:00',
                             '1970-01-01 01:00:00.',
                             '1970-01-01 02:00:00.0',
                             '1970-01-01 03:00:00.00',
                             '1970-01-01 04:00:00.00'],
