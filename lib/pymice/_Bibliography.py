...
class Citation(object):
    ...
    _SOFTWARE_PATTERNS = {
        ...
        'vancouver': ({'txt': u"2. Dzik\xa0JM, Łęski\xa0S, Puścian\xa0A. PyMICE [computer software].{versionString} Warsaw: Nencki Institute{date}.{doi}",
                       'latex': u"\\bibitem{{pymice{version}}} Dzik\xa0JM, Łęski\xa0S, Puścian\xa0A. PyMICE [computer software].{versionString} Warsaw: Nencki Institute{date}.{doi}",
                       },
