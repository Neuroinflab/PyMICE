...
class Citation(object):
    ...
    _SOFTWARE_PATTERNS = {
        ...
        'vancouver': (u"2. Dzik\xa0JM, Łęski\xa0S, Puścian\xa0A. PyMICE [computer software].{version} Warsaw: Nencki Institute{date}.{doi}",
    ...
    _PAPER_PATTERNS = {'apa6': ({'txt': u"{authors} ({date}). {title}. {journal}{doi}",
                       ...
                       'vancouver': (u"1. {authors}. {title}. {journal}. {date}. {doi}",
